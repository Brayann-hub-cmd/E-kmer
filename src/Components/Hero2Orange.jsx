                    ...
                    <div className="flex-1 w-full">
                        ...
                        <div className="flex flex-row justify-center items-center gap-2 sm:gap-3 md:gap-4 lg:gap-5 xl:gap-6">
                            ...
                            <Link
                                ...
                                className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-32 lg:h-32 xl:w-40 xl:h-40 rounded-xl sm:rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300"
                            >
                                <img
                                    src="/Montre.png"
                                    alt="Mode"

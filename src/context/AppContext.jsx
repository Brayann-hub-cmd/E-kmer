  ...
  const translations = {
    ...
    ENG: {
      ...
      uploadError: "Upload error.",
            ...
            // FRA
      loading: "Chargement...",
      timeoutError: "Le serveur met trop de temps à répondre. Vérifiez votre connexion.",
      ...
      phoneFormatHint: "Format : +237 6XX XXX XXX",
      nameMinChars: "Le nom doit contenir au moins 2 caractères",
      invalidEmailFormat: "Format d'email invalide (ex: nom@domaine.com)",
      invalidPhoneFormat: "Format invalide (ex: +237 6XX XXX XXX)",
      ...
      and: "et",
      acceptConditions: "J'accepte les",

      // ENG
      loading: "Loading...",
      timeoutError: "The server is taking too long to respond. Check your connection.",
      ...
      invalidEmailFormat: "Invalid email format (e.g., name@domain.com)",
      invalidPhoneFormat: "Invalid format (e.g., +237 6XX XXX XXX)",
